<?php
    include ('config.php');
    $search = $_POST['search'] ?? '';
    $query = mysqli_query($dbConnect,"SELECT name,email FROM akashadb  WHERE name LIKE '%$search%' AND role='User' ORDER BY 'id' AND 'role'");
?>
<!DOCTYPE html>
<html lang="en">
<head>
                  ...
                  <tbody>
                    <?php  
                            $count='1';
                                ...
                                echo "<tr>";
                                echo "<td class ='border border-dark' scope='row'>".$count."</th>";
